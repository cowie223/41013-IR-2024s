...
for i = 1:steps
    ...
    x(1,i) = (-0.25 + i*0.5/steps);
    x(2,i) = 0.2 + 0.4*i/steps;
    x(3,i) = 0.2 + 0.4*i/steps;
    theta(1, i) = deg2rad(0);
    theta(2, i) = deg2rad(180);
    theta(3, i) = deg2rad(0);


end

q0 = [deg2rad(-95), deg2rad(54.1), deg2rad(-81), deg2rad(-13.1), deg2rad(-34.3), deg2rad(0)];
...
%qMatrix(1,:) = igus.model.ikcon(T, zeros(1, 6));
